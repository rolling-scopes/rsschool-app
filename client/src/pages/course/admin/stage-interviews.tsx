        ...
        columns={[
          {
            ...
            sorter: stringSorter<any>('interviewer.githubId'),
          ...
          },
          {
            title: 'Student',
            dataIndex: 'student',
            sorter: stringSorter<any>('student.githubId'),
            render: value => <PersonCell value={value} showCountry={true} />,
          ...
          },
          {
            ...
            sorter: stringSorter<any>('interviewer.preference'),
            width: 80,
          },
          {
            title: 'Student Score',
            dataIndex: ['student', 'totalScore'],
            sorter: numberSorter<any>('student.totalScore'),
            width: 80,
          },
          {
            title: 'Completed',
            dataIndex: 'completed',
            sorter: stringSorter<any>('completed'),
