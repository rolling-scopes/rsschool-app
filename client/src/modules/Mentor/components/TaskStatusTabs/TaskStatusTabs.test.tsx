...
describe('StatusTabs', () => {
  ...
  it('should render status tabs', () => {
    ...
    render(<TaskStatusTabs statuses={statuses} onTabChange={onTabChangeMock} />);
  ...
  it('should render status tabs when statuses were not provided', () => {
    render(<TaskStatusTabs statuses={[]} onTabChange={onTabChangeMock} />);
  ...
  `(
    ...
    ({ activeTab }: { activeTab: string }) => {
      render(<TaskStatusTabs activeTab={activeTab} statuses={[]} onTabChange={onTabChangeMock} />);
  ...
  describe('when active tab was changed', () => {
    it('should call onTabChange with tab name "all"', () => {
      const statuses = generateStatuses();
      render(<TaskStatusTabs activeTab={StatusEnum.Missed} statuses={statuses} onTabChange={onTabChangeMock} />);
