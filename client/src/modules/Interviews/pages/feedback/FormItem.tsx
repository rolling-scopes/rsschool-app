...
import { StepFormItem, RadioOption } from 'data/interviews/technical-screening';
import { NestedRadio } from './NestedRadio';
import { InputType, StepId } from 'data/interviews';
...
export function FormItem({ item, form, stepId }: { item: StepFormItem; form: FormInstance; stepId: StepId }) {
  switch (item.type) {
