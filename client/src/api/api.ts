...
export const AlertsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    deleteAlert: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/v2/alerts/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
...
export const AlertsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AlertDto>> {
    ...
    async getAlerts(
      enabled: boolean,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AlertDto>>> {
...
export class AlertsApi extends BaseAPI {
  ...
  public createAlert(createAlertDto: CreateAlertDto, options?: AxiosRequestConfig) {
    return AlertsApiFp(this.configuration)
      .createAlert(createAlertDto, options)
...
export const CoursesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getCourse: async (aliasOrId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/v2/courses/{aliasOrId}`.replace(
        `{${'aliasOrId'}}`,
        encodeURIComponent(String(aliasOrId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
...
export const CoursesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getCourses(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CourseDto>>> {
...
export const DisciplinesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    deleteDiscipline: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/v2/disciplines/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
...
export const DisciplinesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createDiscipline(
      createDisciplineDto: CreateDisciplineDto,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DisciplineDto>> {
    ...
    async getDisciplines(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<DisciplineDto>>> {
 ...
 * @export
 */
export const DisciplinesApiFactory = function (
...
export class DisciplinesApi extends BaseAPI {
  ...
  public createDiscipline(createDisciplineDto: CreateDisciplineDto, options?: AxiosRequestConfig) {
    return DisciplinesApiFp(this.configuration)
      .createDiscipline(createDisciplineDto, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public updateDiscipline(id: number, updateDisciplineDto: UpdateDisciplineDto, options?: AxiosRequestConfig) {
    return DisciplinesApiFp(this.configuration)
      .updateDiscipline(id, updateDisciplineDto, options)
      .then(request => request(this.axios, this.basePath));
  }
}
...
export const MentorsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getMentorStudents: async (mentorId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/v2/mentors/{mentorId}/students`.replace(
        `{${'mentorId'}}`,
...
export const MentorsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getMentorStudents(
      mentorId: number,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<MentorStudentDto>>> {
...
export class MentorsApi extends BaseAPI {
  ...
  public getMentorStudents(mentorId: number, options?: AxiosRequestConfig) {
    return MentorsApiFp(this.configuration)
      .getMentorStudents(mentorId, options)
      .then(request => request(this.axios, this.basePath));
  }
}
...
export const ProfileApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getUserCourses: async (username: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/v2/profile/{username}/courses`.replace(
        `{${'username'}}`,
...
export const ProfileApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getUserCourses(
      username: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProfileCourseDto>>> {
...
export class ProfileApi extends BaseAPI {
  ...
  public getUserCourses(username: string, options?: AxiosRequestConfig) {
    return ProfileApiFp(this.configuration)
      .getUserCourses(username, options)
      .then(request => request(this.axios, this.basePath));
  }
}
...
export const StudentsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getStudent: async (studentId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/v2/students/{studentId}`.replace(
        `{${'studentId'}}`,
...
export const StudentsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getStudent(
      studentId: number,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StudentDto>> {
...
export class StudentsApi extends BaseAPI {
  ...
  public getStudent(studentId: number, options?: AxiosRequestConfig) {
    return StudentsApiFp(this.configuration)
...
export const StudentsFeedbacksApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    createStudentFeedback: async (
      studentId: number,
      createStudentFeedbackDto: CreateStudentFeedbackDto,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'studentId' is not null or undefined
      ...
      const localVarPath = `/api/v2/students/{studentId}/feedbacks`.replace(
        `{${'studentId'}}`,
        encodeURIComponent(String(studentId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    updateStudentFeedback: async (
      studentId: number,
      id: number,
      updateStudentFeedbackDto: UpdateStudentFeedbackDto,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'studentId' is not null or undefined
...
export const StudentsFeedbacksApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createStudentFeedback(
      ...
      createStudentFeedbackDto: CreateStudentFeedbackDto,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StudentFeedbackDto>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createStudentFeedback(
        studentId,
        createStudentFeedbackDto,
        options,
      );
    ...
    async updateStudentFeedback(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateStudentFeedback(
        studentId,
        id,
        updateStudentFeedbackDto,
        options,
 ...
 * @export
 */
export const StudentsFeedbacksApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    createStudentFeedback(
      ...
      createStudentFeedbackDto: CreateStudentFeedbackDto,
      options?: any,
    ): AxiosPromise<StudentFeedbackDto> {
      return localVarFp
        .createStudentFeedback(studentId, createStudentFeedbackDto, options)
    ...
    updateStudentFeedback(
      ...
      return localVarFp
        .updateStudentFeedback(studentId, id, updateStudentFeedbackDto, options)
        .then(request => request(axios, basePath));
    },
  };
};
...
export class StudentsFeedbacksApi extends BaseAPI {
  ...
  public createStudentFeedback(
    ...
    return StudentsFeedbacksApiFp(this.configuration)
      .createStudentFeedback(studentId, createStudentFeedbackDto, options)
      .then(request => request(this.axios, this.basePath));
  }
  ...
  public getStudentFeedback(studentId: number, id: number, options?: AxiosRequestConfig) {
    return StudentsFeedbacksApiFp(this.configuration)
      .getStudentFeedback(studentId, id, options)
      .then(request => request(this.axios, this.basePath));
  }
