      ...
      <>
        ...
        <CommonCard
          ...
          content={
            <>
              <div>
                <p>Mentored Students: <Text style={{ fontSize: 18 }} strong>{this.countStudents(stats)}</Text></p>
                <p>Courses as Mentor: <Text style={{ fontSize: 18 }} strong>{stats.length}</Text></p>
              </div>
              <List
