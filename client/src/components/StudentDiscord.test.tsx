...
describe('StudentDiscord', () => {
  it('renders Discord details for discriminator, modern username, missing account, and prefix variants', () => {
    const { rerender } = render(<StudentDiscord discord={{ id: '123', username: 'johnny', discriminator: '4567' }} />);
    ...
    rerender(<StudentDiscord discord={{ id: '1', username: 'plainuser', discriminator: '0' }} />);
    ...
    rerender(<StudentDiscord discord={null} textPrefix="Discord:" />);
