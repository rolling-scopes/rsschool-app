  ...
  items: [
    {
      ...
      options: [
        { id: 'done', title: "Yes, it's ok." },
        {
          ...
          options: [
            { id: FailedDecision.MissedWithReason, title: 'Student has a significant reason.' },
            { id: FailedDecision.MissedIgnoresMentor, title: 'Student ignores mentor.' },
            { id: FailedDecision.MissedSeparateStudy, title: 'Student continues separate studying.' },
          ],
        },
      ],
    },
