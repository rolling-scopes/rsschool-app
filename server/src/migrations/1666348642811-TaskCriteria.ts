...
export class TaskCriteria1666348642811 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "task_criteria" ("taskId" integer NOT NULL, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "criteria" jsonb NOT NULL DEFAULT '[]', CONSTRAINT "PK_6de018b8a8dbe8845ffe811ad20" PRIMARY KEY ("taskId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_91f8c79680ddb1486f56128a9d6" FOREIGN KEY ("criteriaId") REFERENCES "task_criteria"("taskId") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
