...
export class VerificationAnswers1673088410406 implements MigrationInterface {
    name = 'VerificationAnswers1673088410406'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "event" RENAME COLUMN "discipline" TO "disciplineId"`);
        await queryRunner.query(`CREATE TABLE "discipline" ("id" SERIAL NOT NULL, "created_date" TIMESTAMP NOT NULL DEFAULT now(), "updated_date" TIMESTAMP NOT NULL DEFAULT now(), "deleted_date" TIMESTAMP, "name" character varying NOT NULL, CONSTRAINT "PK_139512aefbb11a5b2fa92696828" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "team_distribution" ("id" SERIAL NOT NULL, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "courseId" integer, "startDate" TIMESTAMP WITH TIME ZONE NOT NULL, "endDate" TIMESTAMP WITH TIME ZONE NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL DEFAULT '', "descriptionUrl" character varying NOT NULL DEFAULT '', "minStudents" integer NOT NULL DEFAULT '2', "maxStudents" integer NOT NULL DEFAULT '4', "studentsCount" integer NOT NULL DEFAULT '3', "strictStudentsCount" boolean NOT NULL DEFAULT true, "minTotalScore" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_432a4b1c8bfacae59140f6fcaf8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_951e2b89c3a2b4554516409cfb" ON "team_distribution" ("courseId") `);
        await queryRunner.query(`CREATE TABLE "history" ("id" SERIAL NOT NULL, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "event" character varying NOT NULL, "entityId" integer, "operation" character varying NOT NULL, "update" json, "previous" json, CONSTRAINT "PK_9384942edf4804b38ca0ee51416" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."course_task_crosscheckstatus_enum" AS ENUM('initial', 'distributed', 'completed')`);
        await queryRunner.query(`ALTER TABLE "course_task" ADD "crossCheckStatus" "public"."course_task_crosscheckstatus_enum" NOT NULL DEFAULT 'initial'`);
        ...
        await queryRunner.query(`ALTER TABLE "course" ADD CONSTRAINT "FK_7dc67e5ff23f9a74b7cb129a088" FOREIGN KEY ("disciplineId") REFERENCES "discipline"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_9e32af93bbf4f4dcf66387b3073" FOREIGN KEY ("disciplineId") REFERENCES "discipline"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "event" ADD CONSTRAINT "FK_868c8f954dd31217a7e0981b1d2" FOREIGN KEY ("disciplineId") REFERENCES "discipline"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "notification" ADD CONSTRAINT "FK_b7386b61afc53e6b82251e41b5c" FOREIGN KEY ("parentId") REFERENCES "notification"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
