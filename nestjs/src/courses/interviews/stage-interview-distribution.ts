// Ported verbatim from server/src/rules/interviews.ts (stage interview distribution algorithm)
...
export type InterviewInfo = {
  id: number;
  student: { id: number; githubId: string };
  interviewer: { id: number; githubId: string };
};
